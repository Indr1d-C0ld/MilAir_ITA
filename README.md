...
3. **Presentazione** — l'applicazione PHP legge `events.db` e mostra i contatti su una mappa [Leaflet](https://leafletjs.com/), con arricchimento progressivo in background: rarità dei contatti, foto/silhouette/disegni tecnici del modello (scaricati da fonti pubbliche), overlay meteo/satellite, NOTAM, alert e rassegna stampa correlata.
